package com.example.timeline.Adapters;
...
import com.example.timeline.Util.DensityUtil;
import com.example.timeline.Activity.MainActivity;
import com.example.timeline.R;
import com.example.timeline.Time.TimeData;
import com.example.timeline.Time.TimeFormat;
...
public class TimeAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.timeview, parent, false));
